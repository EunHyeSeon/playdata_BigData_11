...
<br><br><br>
<a href="${pageContext.request.contextPath}/rest/recipientUpdateReq?recipientId=${requestScope.recipient.id}">수정하기</a>

<a href="${pageContext.request.contextPath}/rest/recipientDelete?recipientId=${requestScope.recipient.id}">탈퇴하기</a>
